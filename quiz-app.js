// --- البداية: بنك الأسئلة كما في questions.js ---
window.questionsBank = window.questionsBank || {};
window.questionsBank.easy = [
  // ... (ضع هنا جميع أسئلة easy من ملف questions.js كما أرسلتها أنت)
];
window.questionsBank.medium = [
  // ... (ضع هنا جميع أسئلة medium من ملف questions.js كما أرسلتها أنت)
];
window.questionsBank.hard = [
  // ... (ضع هنا جميع أسئلة hard من ملف questions.js كما أرسلتها أنت)
];
// --- نهاية بنك الأسئلة ---
